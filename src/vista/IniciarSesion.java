...
public class IniciarSesion extends javax.swing.JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent evento) {
        ...
        if (evento.getSource() == this.jButton4) {
            ...
            FolderProxy fp = new FolderProxy(login, password);
            String key = fp.performOperation();
            ...
            if(key==null){
                ...
                if(user.getTipoUsuario().equals("Trabajador")){
                    ...
                    MenuTrabajador e = new MenuTrabajador(this, key);
                }else if(user.getTipoUsuario().equals("Empresa")){
                    System.out.println("INGRESAR COMO EMPRESA");
                    this.setVisible(false);
                    MenuEmpresa e = new MenuEmpresa(this, key);
                    ...
                    this.setVisible(false);
                    MenuAdministrador e = new MenuAdministrador(this, key);
                }
            }
        }
